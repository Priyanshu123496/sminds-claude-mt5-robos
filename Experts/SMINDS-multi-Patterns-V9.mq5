...
input long   InpMagicNumber       = 95001009;        // Magic number
input string InpOrderComment      = "SMINDS-MP-V9";  // Order comment
...
input double InpRRRatio           = 3.0;             // V6: 3:1 R:R as user-specified target
