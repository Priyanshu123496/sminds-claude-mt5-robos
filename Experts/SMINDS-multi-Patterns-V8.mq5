...
input long   InpMagicNumber       = 95001008;        // Magic number
input string InpOrderComment      = "SMINDS-MP-V8";  // Order comment
...
input bool   InpRequireBreakout   = true;            // V3: Require next-bar breakout to confirm pattern
...
input bool   InpUseInsideBar      = false;           // V3: Disabled (too noisy on M5)
...
input double InpMinADX            = 30.0;            // V8: very strong trend only
...
input int    InpMaxTradesPerDay   = 2;               // Hard cap on trades per calendar day
