...
input long   InpMagicNumber       = 95001007;        // Magic number
input string InpOrderComment      = "SMINDS-MP-V7";  // Order comment
...
input bool   InpUseBreakEven      = false;           // V7: disabled — let runner go to TP or original SL
...
input double InpMinADX            = 25.0;            // Trend strength threshold (V3 tightened)
