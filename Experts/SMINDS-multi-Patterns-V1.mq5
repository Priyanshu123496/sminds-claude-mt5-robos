//+------------------------------------------------------------------+
//|                                  SMINDS-multi-Patterns-V1.mq5  |
//|                                       Sminds Global Inc. (c)2026 |
//|                                                                  |
//|  Phase 1: Multi-pattern detection EA for XAUUSD M5.              |
//|                                                                  |
...
input long   InpMagicNumber       = 95001001;        // Magic number
input string InpOrderComment      = "SMINDS-MP-V1";  // Order comment
...
input double InpMinBodyATR        = 0.30;            // Min pattern body size as fraction of ATR
input double InpPinWickRatio      = 2.0;             // Pin bar long-wick must be >= this × body
input double InpPinOppWickMaxR    = 0.30;            // Pin bar opposite wick max as fraction of body
