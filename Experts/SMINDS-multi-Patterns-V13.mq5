...
input long   InpMagicNumber       = 95001013;        // Magic number
input string InpOrderComment      = "SMINDS-MP-V13";  // Order comment
...
input double InpRiskPercent       = 1.0;             // V6: lowered to 1% for sustainable compounding
input double InpMaxLotSize        = 1.50;            // V6: hard cap on lot to prevent runaway compounding
...
input bool   InpUsePartialClose   = false;           // V13: pure 2:1            // Close half at 1R, runner to TP
