...
input long   InpMagicNumber       = 95001004;        // Magic number
input string InpOrderComment      = "SMINDS-MP-V4";  // Order comment
...
input double InpBreakEvenOffsetR  = 0.1;             // Lock-in offset from entry (× SL distance)
